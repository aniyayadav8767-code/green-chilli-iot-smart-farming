    ...
    <div className="relative">
      ...
      >
        ...
        <div className="hidden xl:block text-left">
          <span className="text-xs font-bold text-slate-800 block -mb-0.5">Dr. A. Devan</span>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 glass-card rounded-2xl p-2 shadow-xl border border-slate-200/90 z-50 animate-in fade-in zoom-in-95 space-y-1">
          <div className="px-3 py-2 border-b border-slate-100">
            <p className="text-xs font-extrabold text-slate-900">Dr. A. Devan</p>
            <p className="text-[10px] text-slate-400 truncate">agronomist@smartfarming.edu</p>
          </div>
