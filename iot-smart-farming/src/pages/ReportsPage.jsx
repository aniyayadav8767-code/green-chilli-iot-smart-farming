    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="glass-card rounded-3xl p-8 border border-slate-200/90 shadow-2xl space-y-6 max-w-4xl mx-auto bg-white">
        ...
        <div className="space-y-3 text-xs text-slate-700 leading-relaxed">
          ...
          <p>
            During the {reportType} evaluation window, environmental parameters remained strictly within optimal thresholds for Solanaceous green chilli cultivation. DHT11 temperature telemetry recorded a peak high of 30.2°C at 12:45 PM and a night minimum of 20.5°C.
          </p>
