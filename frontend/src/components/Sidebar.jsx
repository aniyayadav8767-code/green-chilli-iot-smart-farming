...
const navItems = [
  ...
  { name: 'AI Disease Analysis', path: '/ai-analysis', icon: Scan, badge: 'AI Live' },
  ...
  { name: 'Sensor History', path: '/history', icon: History },
        ...
        <div className="flex items-center justify-between p-2 rounded-xl hover:bg-white transition-colors cursor-pointer mb-1 border border-transparent hover:border-slate-200/80">
          <div className="flex items-center gap-2.5">
            ...
            <div className="overflow-hidden">
              <p className="text-xs font-semibold text-slate-800 truncate">Aniya Yadav</p>
