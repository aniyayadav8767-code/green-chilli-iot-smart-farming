...
export const initialAICropHealth = {
  ...
  aiResult: {
    diseaseName: 'Green Chilli(Alternaria solani)',
  ...
  recentScans: [
    { id: 1, time: '14:46:12', result: 'Tomato Early Blight', confidence: '96.8%', status: 'Mild', image: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb179a5?auto=format&fit=crop&w=400&q=80' },
...
export const irrigationSystemData = {
  ...
  schedules: [
    { id: 1, time: '06:30 AM', duration: '20 mins', zone: 'Zone A (Tomatoes)', trigger: 'Moisture < 35%', status: 'Completed' },
    { id: 2, time: '02:30 PM', duration: '15 mins', zone: 'Zone A (Tomatoes)', trigger: 'Moisture < 40%', status: 'Completed' },
...
export const recentAlerts = [
  ...
  { id: 2, type: 'warning', title: 'Early Blight Detected by AI', message: 'ESP32-CAM captured leaf spot. MobileNetV2 flagged Tomato Early Blight with 96.8% confidence.', time: '2 mins ago' },
